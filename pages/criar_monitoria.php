...
require_once __DIR__ . '/../src/controllers/criar_monitoria_dados.php';
?>

<div class="container">
    <div class="header" style="background: <?php echo $cor_disciplina; ?>;">
        <h1>Criar Nova Monitoria</h1>
        <p>Preencha os dados da sua monitoria para disponibilizá-la aos alunos</p>
    </div>

    <form class="form-container" method="POST" id="form-monitoria" action="../src/controllers/criar_monitoria_backend.php">
        <div class="form-grid">
            <div class="form-main">
                <div class="info-box">
                ...
                <div class="form-group">
                    ...
                    <input type="number" name="capacidade" min="1" max="30" placeholder="Número máximo de alunos" required>
        ...
        <div class="form-actions">
            ...
            <button type="submit" name="criar_monitoria" class="btn-submit">Criar Monitoria</button>
        </div>
    </form>
</div>
...
$scripts = ["editar_monitoriaJs/criar_verificar"];
